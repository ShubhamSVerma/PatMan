...
<body>
    ...
    <section class="about">
        <div class="content">
            ...
            <p style=" color: aliceblue;"><span style="font-size: 200%; font-weight: bold;">Our Mission</span><br><b>To provide the right information in the right place, in the right order, at the right time for the right person.<b></p>
        </div>
        <div class="container">
            <div class="video">
